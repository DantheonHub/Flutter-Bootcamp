...
- **Módulo 3 — Flutter** *(en curso)*: widgets fundamentales (`Card`, `Container`, `ListTile`, menús, ventanas flotantes), árbol de widgets, `StatelessWidget`/`StatefulWidget` y manejo básico de estado.
